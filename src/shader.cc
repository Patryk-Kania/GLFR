...
namespace glfr
{
	...
	void Shader::SetUniformValue(const char *name, glm::mat4x3 value)
	{
		GLint uniformLocation = glGetUniformLocation(m_shaderProgram, name);
		glUniformMatrix4x3fv(uniformLocation, 1, GL_FALSE, &value[0][0]);
	}

	void Shader::SetUniformValue(const char *name, glm::mat4x2 value) 
	{
		GLint uniformLocation = glGetUniformLocation(m_shaderProgram, name);
		glUniformMatrix4x2fv(uniformLocation, 1, GL_FALSE, &value[0][0]);
	}

	void Shader::SetUniformValue(const char *name, glm::mat3 value)
	{
		GLint uniformLocation = glGetUniformLocation(m_shaderProgram, name);
		glUniformMatrix3fv(uniformLocation, 1, GL_FALSE, &value[0][0]);
	}

	void Shader::SetUniformValue(const char *name, glm::mat3x4 value) 
	{
		GLint uniformLocation = glGetUniformLocation(m_shaderProgram, name);
		glUniformMatrix3x4fv(uniformLocation, 1, GL_FALSE, &value[0][0]);
	}

	void Shader::SetUniformValue(const char *name, glm::mat3x2 value) 
	{
		GLint uniformLocation = glGetUniformLocation(m_shaderProgram, name);
		glUniformMatrix3x2fv(uniformLocation, 1, GL_FALSE, &value[0][0]);
	}

	void Shader::SetUniformValue(const char *name, glm::mat2 value)
	{
		GLint uniformLocation = glGetUniformLocation(m_shaderProgram, name);
		glUniformMatrix2fv(uniformLocation, 1, GL_FALSE, &value[0][0]);
	}

	void Shader::SetUniformValue(const char *name, glm::mat2x4 value) 
	{
		GLint uniformLocation = glGetUniformLocation(m_shaderProgram, name);
		glUniformMatrix2x4fv(uniformLocation, 1, GL_FALSE, &value[0][0]);
	}

	void Shader::SetUniformValue(const char *name, glm::mat2x3 value) 
	{
		GLint uniformLocation = glGetUniformLocation(m_shaderProgram, name);
	...
	void Shader::SetUniformValue(const char *name, glm::vec4 value)
	{
		GLint uniformLocation = glGetUniformLocation(m_shaderProgram, name);
		glUniform4fv(uniformLocation, 4,  &value[0]);
	}

	void Shader::SetUniformValue(const char *name, glm::vec3 value) 
	{
		GLint uniformLocation = glGetUniformLocation(m_shaderProgram, name);
	...
	void Shader::SetUniformValue(const char *name, float x, float y, float z, float w) 
	{
		GLint uniformLocation = glGetUniformLocation(m_shaderProgram, name);
		glUniform4f(uniformLocation, x, y, z, w);
	}

	void Shader::SetUniformValue(const char *name, float x, float y, float z)
	{
		GLint uniformLocation = glGetUniformLocation(m_shaderProgram, name);
		glUniform3f(uniformLocation, x, y, z);
	}

	void Shader::SetUniformValue(const char *name, float x, float y)
	{
		GLint uniformLocation = glGetUniformLocation(m_shaderProgram, name);
		glUniform2f(uniformLocation, x, y);
	}

	void Shader::SetUniformValue(const char *name, float x)
	{
		GLint uniformLocation = glGetUniformLocation(m_shaderProgram, name);
